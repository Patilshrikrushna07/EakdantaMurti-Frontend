...
export const NewArrivalSale = () => {
  return (
    <div className='flex flex-row  bg-[url("/newarrival.jpg")] bg-no-repeat md:bg-cover shadow-md '>
      ...
      <div className=" md:ml-[55%] flex flex-col justify-center space-y-4 p-[5vh] ">
        ...
        <Link href='/shop'><button className="bg-[#6D4128] text-white font-bold md:w-[12vw] md:p-[3vh] p-[1.5vh]">PRE BOOK</button>
        </Link>
      </div>
    </div>
  )
