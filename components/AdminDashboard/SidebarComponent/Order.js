  ...
  const recentOrders = [
    {
      ...
      quantity: 5,
      products: [
        { id: 1, name: 'Product 1', price: 10, quantity: 2, image: '/sale1.jpg' },
        { id: 2, name: 'Product 2', price: 20, quantity: 3, image: '/sale2.jpg' },
        ...
        <tbody>
          {recentOrders.map((order) => (
            <tr key={order.id} >
              ...
              <td className="border px-4 py-2  text-center">{order.customer}</td>
              ...
              <td className="border px-4 py-2  text-center">
                <button onClick={() => handleOrderClick(order)} className="bg-blue-500 text-white px-4 py-2 rounded-md">View</button>
              </td>
            </tr>
          ))}
        </tbody>
        ...
        <tbody>
          {selectedOrder.products.map((product) => (
            <tr key={product.id}>
              ...
              <td className="border px-4 py-2"><img src={product.image} alt={product.name} className="w-10 h-10 inline-block mr-2" /></td>
            </tr>
          ))}
        </tbody>
      </table>
